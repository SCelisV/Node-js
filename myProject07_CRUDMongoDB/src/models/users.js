...
usersSchema.methods.matchPass = async function(password) { // => compara las contraseñas (cifradas) cuando el usuario hace login
...
module.exports = model('users', usersSchema) // => Nombre del modelo y Nombre del esquema